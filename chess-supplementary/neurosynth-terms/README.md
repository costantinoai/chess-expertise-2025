...
- **Neurosynth meta-analysis** (`chess-neurosynth/`): Uses these term maps for correlation analyses
- **Dataset visualization** (`chess-supplementary/dataset-viz/`): Provides colorbars for term maps
