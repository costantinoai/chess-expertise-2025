...
logger.info("Loading MVPA finer group statistics (RSA half)...")

# RSA half of the split stats pair, produced by
# 02_mvpa_finer_group_rsa.py. The decoding half is read by
# 82_table_mvpa_finer_decoding.py from the matching _svm file.
_stats_path = RESULTS_DIR / 'mvpa_finer_group_stats_rsa.pkl'
