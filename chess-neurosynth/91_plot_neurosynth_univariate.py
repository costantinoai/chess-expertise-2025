...
plt.figure(1).ax_dict["B1_Corr_Check_gt_NoCheck"].set(position=[0.5479, 0.4808, 0.2188, 0.2177])
plt.figure(1).ax_dict["B1_Corr_Check_gt_NoCheck"].set_position([0.548255, 0.385487, 0.216904, 0.258545])
plt.figure(1).ax_dict["B1_Corr_Check_gt_NoCheck"].texts[14].set(position=(0.5, 1.071))
plt.figure(1).ax_dict["B1_Corr_Check_gt_NoCheck"].texts[15].set(position=(0.5, 1.016))
...
plt.figure(1).ax_dict["C_Flat_All_gt_Rest"].texts[0].set(position=(0.4951, 1.009))
plt.figure(1).ax_dict["C_Flat_All_gt_Rest"].texts[1].set(position=(0.4951, 0.9546))
